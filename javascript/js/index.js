...
/* var x = 'this is literally a string'; */
let x = 'this is literally a string'; // Some browsers don't use let
...
var temp = 5;
if (temp > 0) {
    var temp = 1; // resets temp variable to 1
    temp++;
}
...
// console.log('temp = ', temp); returns a number String can contain #
// but # can't contain a string

let temp2 = 5;
if (temp2 > 0) {
    let temp2 = 1; // Doesn't jump outside of the function, resets
    temp2++;
}
...
let courses = ["INFO 343", "INFO 201", "EDPSE 422"];
courses.push("INFO 498");

//TODO: write the last element in the array to the console
console.log(courses[courses.length - 1]); // grabs last item
...
//the for...in syntax
console.group("keys/values from player using for...in"); // shrink in console
//TODO: iterate over all keys/values using for...in
for (let prop in player) { // gets all the keys
    console.log(prop, player[prop]); // gets the value of prop
}
console.groupEnd();
